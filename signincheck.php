  ...
  <div class="container">
      <?php
        ...
        else
        {
          ...
          $create_user_friend_query = "CREATE TABLE `CHAT`.`friend_".$user_info["id"]."` (`friend_id` INT NOT NULL, `friend_group` INT NULL, `friend_care` INT NULL, PRIMARY KEY (`friend_id`))";
